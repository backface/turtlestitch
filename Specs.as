...
public class Specs {
	...
	public static var commands:Array = [
		...
		["noop",								"r", 99, "COUNT"],
		["counter",								"r", 14, "COUNT"],
		["clear counter",						" ", 14, "CLR_COUNT"],
		["incr counter",						" ", 14, "INCR_COUNT"],
		["for each %m.varName in %s",			"c", 14, "doForLoop", "v", 10],
		["while %b",							"c", 14, "doWhile"],
		["all at once",							"c", 14, "warpSpeed"],

		// stage motion (scrolling)
		["scroll right %n",						" ", 14, "scrollRight",		10],
		["scroll up %n",						" ", 14, "scrollUp",		10],
		["align scene %m.scrollAlign",			" ", 14, "scrollAlign",		'bottom-left'],
		["x scroll",							"r", 14, "xScroll"],
		["y scroll",							"r", 14, "yScroll"],

		// other obsolete blocks from alpha/beta
		["hide all sprites",					" ", 14, "hideAll"],
		["user id",								"r", 14, "getUserId"],
